...
public class OSSClientUtil {
    ...
    // accessKey		替换成自己的
    private String accessKeyId = "xxxxxxxxxxxxxxxx";
    //accessKeySecret 	替换成自己的
    private String accessKeySecret = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
    // Bucket名称		替换成自己的
    private String bucketName = "zhou870498";
    // 文件存储目录		替换成自己的
